...
// let DEFAULT_SERVER = 'http://100.106.94.95:6200'; // mac mini bones in apt101 via tailscale
// let DEFAULT_SERVER_IP = 'http://100.72.251.34:6200'; // macbook pro via tailscale
let DEFAULT_SERVER = 'https://bf823832028e.ngrok-free.app';
const API_BASE_URL = (process.env.EXPO_PUBLIC_API_URL ?? `${DEFAULT_SERVER}`).replace(/\/$/, '');
